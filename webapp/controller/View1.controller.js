      ...
      onPrint: function(oEvent) {
              ...
              aSelectedIndices.forEach(function(index) {
                ...
                for (var i = 0; i < oData.results.length; i++) {
                  if (oData.results[i].TspId === oObject.TspId) {
                    // If there is a match, set TspIdNotPrint to true and break the loop
                    TspIdNotPrint = true;
                    break;
                  }
                }
              });
              resolve(TspIdNotPrint); // Resolve the promise once TspId validation is done
            },
        ...
        tspIdValidationPromise
          .then(function(TspIdNotPrint) {
            ...
            // PrintStatus = 'Printed'? Show Confirm Message
